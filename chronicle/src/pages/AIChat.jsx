  ...
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content:
        "Hello! I'm your Life Story companion. I can help you reflect on your journey, explore patterns in your entries, or guide you through meaningful writing prompts. What would you like to talk about?",
    },
  ]);
    ...
    <div className="max-w-4xl mx-auto h-[calc(100vh-12rem)]">
      ...
      >
        ...
        <p className="text-slate-400">
          Chat with your personal reflection companion
        </p>
      </motion.div>
