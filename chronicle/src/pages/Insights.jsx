    ...
    <div className="max-w-6xl mx-auto">
      ...
      >
        ...
        <p className="text-slate-400 mb-8">
          Patterns and discoveries from your journey
        </p>
      </motion.div>
        ...
        >
          <Card className="bg-gradient-to-br from-theme/20 to-theme/5 border-glow p-6">
            ...
            <p className="text-slate-300">
              You've documented {entries.length} moments of your life. Every
              entry is a step toward understanding yourself better.
            </p>
          </Card>
        </motion.div>
      )}
